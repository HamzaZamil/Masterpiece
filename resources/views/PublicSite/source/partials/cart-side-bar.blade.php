        ...
        <div class="cart_items_list">
            <div class="cart_item">
                <div class="item_image">
                    <img src={{asset("assets/user/images/main-thumb/collection-thumb.jpg")}} alt="image_not_found">
                </div>
            ...
            <div class="cart_item">
                <div class="item_image">
                    <img src={{asset("assets/user/images/main-thumb/collection-thumb2.jpg")}} alt="image_not_found">
                </div>
                <div class="item_content">
                    <h4 class="item_title">
                        Rorem ipsum dolor sit amet, sectetur adipisi cingey.
            ...
            <div class="cart_item">
                <div class="item_image">
                    <img src={{asset("assets/user/images/main-thumb/collection-thumb3.jpg")}} alt="image_not_found">
                </div>
                <div class="item_content">
                    <h4 class="item_title">
                        Rorem ipsum dolor sit amet, sectetur adipisi cingey.
            ...
            <div class="cart_item">
                <div class="item_image">
                    <img src={{asset("assets/user/images/main-thumb/collection-thumb4.jpg")}} alt="image_not_found">
                </div>
                <div class="item_content">
                    <h4 class="item_title">
                        Rorem ipsum dolor sit amet, sectetur adipisi cingey.
