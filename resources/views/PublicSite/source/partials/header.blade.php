...
<!-- Mirrored from m100.ditsolution.net/html/cat-shop/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Nov 2024 10:50:45 GMT -->
...
<head>
	...
	<!-- Animate CSS Link -->
	<link rel="stylesheet" href={{asset("assets/user/css/animate.css")}} type="text/css" media="all">
	<!-- Animated text CSS Link -->
	<link rel="stylesheet" href={{asset("assets/user/css/animated-text.css")}} type="text/css" media="all">
	<!-- Font Awesome CSS Link -->
	<link rel="stylesheet" href={{asset("assets/user/css/all.min.css")}} type="text/css" media="all">
	...
	<!-- Slick CSS Link -->
	<link rel="stylesheet" href={{asset("assets/user/css/slick.css")}} type="text/css" media="all">
