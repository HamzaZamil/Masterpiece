          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="container mt-5">
                <h2>Add Pet</h2>
                <form action="{{ route('admin.pets.editPet') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="mb-3">
                    ...
                    <input type="file" class="form-control" id="petPicture" name="pet_picture" accept="image/*" required>
                  </div>
